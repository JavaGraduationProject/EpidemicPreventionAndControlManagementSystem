  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
     ...
     <li class="layui-nav-item layui-nav-itemed">
            ...
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="我的信息"    data-href="${pageContext.request.contextPath}/hospital/hospital_info/detail">我的信息  </a>  </dd>
            </dl>
 </li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">我的需求 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="我的需求"    data-href="${pageContext.request.contextPath}/hospital/hospital_need_info">我的需求  </a>  </dd>
            </dl>
 </li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">厂商订单 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="厂商订单"    data-href="${pageContext.request.contextPath}/hospital/order_info">厂商订单  </a>  </dd>
            </dl>
 </li>
...
addTab("我的信息", "${pageContext.request.contextPath}/hospital/hospital_info/detail");
function goPage(e){
