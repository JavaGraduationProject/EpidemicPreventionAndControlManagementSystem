                ...
                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                    ...
                    <c:forEach items="${needStatusList}" var="item">
                        <option value="${item.id}">${item.name}</option>
                            ...
                            <a href="${pageContext.request.contextPath}/hospital/hospital_need_info/add" class="layui-btn layui-btn-radius">发布需求</a>
                                    ...
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/page/myPagination.js"></script>
                                        ...
                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layui/layui.js"></script>
                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layuiutil.js"></script>
                                                ...
                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=0309"></script>
                                                    ...
                                                    function ajaxList(page) {
                                                        ...
                                                        showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                            $.ajax({
                                                                type : 'get',
                                                                url : "${pageContext.request.contextPath}/hospital/hospital_need_info/queryList",
                                                                    data : {
                                                                        "page":page,
                                                                        "wzName":wzName,
                                                                    ...
                                                                    success : function(result) {
                                                                        ...
                                                                        for (var i = 0; i < rows.length; i++) {
                                                                            ...
                                                                            html+='<td>';
                                                                            if(rows[i].hospitalNeedInfo.needStatus=='1'){
                                                                                html+='<a href="${pageContext.request.contextPath}/hospital/hospital_need_info/update?id='+rows[i].hospitalNeedInfo.id+'" class="layui-btn layui-btn-normal layui-btn-radius btnStyle">修改</a>';
                                                                                }
                                                                                if(rows[i].hospitalNeedInfo.needStatus=='1'){
                                                                                    html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].hospitalNeedInfo.id+'" class="layui-btn layui-btn-danger layui-btn-radius btnStyle">删除</a>';
                                                                                }
                                                                                if(rows[i].hospitalNeedInfo.needStatus=='1'){
                                                                                    html+='<a href="javascript:void(0)" onclick="updateByDefault(this)" data-id="'+rows[i].hospitalNeedInfo.id+'" act-type="1" class="layui-btn layui-btn-warm layui-btn-radius btnStyle">发布需求</a>';
                                                                                }
                                                                                html+='</td>';
                                                                                html+='</tr>';
                                                                            }
                                                                ...
                                                                function updateByDefault(e){
                                                                    ...
                                                                    if(r==true){
                                                                        ...
                                                                        $.ajax({
                                                                            type : 'get',
                                                                            url : "${pageContext.request.contextPath}/hospital/hospital_need_info/updateByDefault",
                                                                                data : {
                                                                                    "id":id
                                                                                },
                                                                                success : function(result) {
                                                                    ...
                                                                    function del(e){
                                                                        if(window.confirm('你确定要删除该医院需求吗')){
                                                                            var id = $(e).attr("data-id");
                                                                            $.ajax({
                                                                                type : 'get',
                                                                                url : "${pageContext.request.contextPath}/hospital/hospital_need_info/del",
                                                                                    data : {
                                                                                        "id":id
                                                                                    },
                                                                                    success : function(result) {
