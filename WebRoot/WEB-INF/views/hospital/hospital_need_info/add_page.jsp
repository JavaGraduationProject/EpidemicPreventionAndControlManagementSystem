        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/layui/css/layui.css">
            ...
            <c:forEach items="${wzTypeList}" var="item">
                <option value="${item.id}">${item.name}</option>
                    ...
                    <div class="layui-input-block">
                    <input type="text"  style="width:500px;display:inline"  placeholder="请输入物资名" id="wzName" class="layui-input">
                    </div>
                    </div>
                    ...
                    <div class="layui-input-block">
                    <input type="text"  style="width:500px;display:inline"  placeholder="请输入需求数量（请输入数字）" id="wzNum" class="layui-input">
                    </div>
                    </div>
                    ...
                    <div class="layui-input-block">
                    <input type="text"  style="width:500px;display:inline"  placeholder="请输入备注" id="remark" class="layui-input">
                    </div>
                    </div>
                    ...
                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                        ...
                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layui/layui.js"></script>
                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4356"></script>
                                ...
                                function wzTypeChangeEffectOtherCols(){
                                    ...
                                    function submitData(){
                                        ...
                                        $.ajax({
                                            type: 'post',
                                            url: '${pageContext.request.contextPath}/hospital/hospital_need_info/add_submit',
                                                data:{
                                                    "wzType":wzType,
                                                    "wzName":wzName,
                                                    "wzNum":wzNum,
