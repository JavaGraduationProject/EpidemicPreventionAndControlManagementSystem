                                ...
                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/page/myPagination.js"></script>
                                    ...
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layui/layui.js"></script>
                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layuiutil.js"></script>
                                            ...
                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=7933"></script>
                                                ...
                                                function ajaxList(page) {
                                                    ...
                                                    showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                        $.ajax({
                                                            type : 'get',
                                                            url : "${pageContext.request.contextPath}/hospital/order_info/queryList",
                                                                data : {
                                                                    "page":page,
                                                                    "wzName":wzName,
                                                                ...
                                                                success : function(result) {
                                                                    ...
                                                                    for (var i = 0; i < rows.length; i++) {
                                                                        ...
                                                                        html+='<td>';
                                                                        if(rows[i].orderInfo.orderStatus=='1'){
                                                                            html+='<a href="javascript:void(0)" onclick="updateByDefault(this)" data-id="'+rows[i].orderInfo.id+'" act-type="1" class="layui-btn layui-btn-normal layui-btn-radius btnStyle">接受订单</a>';
                                                                        }
                                                                        if(rows[i].orderInfo.orderStatus=='1'){
                                                                            html+='<a href="javascript:void(0)" onclick="updateByDefault(this)" data-id="'+rows[i].orderInfo.id+'" act-type="2" class="layui-btn layui-btn-danger layui-btn-radius btnStyle">拒绝订单</a>';
                                                                        }
                                                                        if(rows[i].orderInfo.orderStatus=='3'){
                                                                            html+='<a href="javascript:void(0)" onclick="updateByDefault(this)" data-id="'+rows[i].orderInfo.id+'" act-type="3" class="layui-btn layui-btn-warm layui-btn-radius btnStyle">确认收货</a>';
                                                                        }
                                                                        html+='</td>';
                                                                        html+='</tr>';
                                                                    }
                                                        ...
                                                        function updateByDefault(e){
                                                            ...
                                                            if(r==true){
                                                                ...
                                                                $.ajax({
                                                                    type : 'get',
                                                                    url : "${pageContext.request.contextPath}/hospital/order_info/updateByDefault",
                                                                        data : {
                                                                            "id":id,
                                                                            "type":type
                                                                        },
