        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/css/global.css">
            <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/icheck/minimal/red.css">
                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                    ...
                    <legend>活动-详情页</legend>
                    <div class="layui-field-box">
                    <table  class="layui-table">
                    <thead>
                    <tr>
                    <th colspan="2" scope="col">活动-详情页</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <tr>
                    <th width="30%">活动大图</th>
                    <th width="30%"><img src="${detail.actInfo.actImg}" style="width:200px" /></th>
                        </tr>
                        <tr>
                        <th width="30%">活动标题</th>
                        <th width="30%">${detail.actInfo.actTitle}</th>
                            </tr>
                            <tr>
                            <th width="30%">活动内容</th>
                            <th width="30%">${detail.actInfo.actContent}</th>
                                </tr>
                                <tr>
                                <th width="30%">创建时间</th>
                                <th width="30%">${detail.actInfo.createTime}</th>
                                    </tr>
