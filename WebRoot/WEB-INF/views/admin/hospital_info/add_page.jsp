...
<c:set var="uri" value="${pageContext.request.contextPath}" />
    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/layui/css/layui.css">
            ...
            <div class="layui-input-block">
            <input type="text"  style="width:500px;display:inline"  placeholder="请输入医院名" id="hospitalName" class="layui-input">
            </div>
            </div>
            ...
            <div class="layui-input-block">
            <input type="text"  style="width:500px;display:inline"  placeholder="请输入医院地址" id="address" class="layui-input">
            </div>
            </div>
            ...
            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                ...
                <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layui/layui.js"></script>
                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8458"></script>
                        ...
                        function submitData(){
                            ...
                            $.ajax({
                                type: 'post',
                                url: '${pageContext.request.contextPath}/admin/hospital_info/add_submit',
                                    data:{
                                        "name":name,
                                        "passWord":passWord,
