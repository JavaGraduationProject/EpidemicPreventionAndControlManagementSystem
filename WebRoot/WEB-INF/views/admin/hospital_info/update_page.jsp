        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/layui/css/layui.css">
            ...
            <input type="text"  style="width:500px;display:inline" value="${data.name}" placeholder="请输入登录名" id="name" class="layui-input">
                ...
                <input type="text"  style="width:500px;display:inline" value="${data.passWord}" placeholder="请输入登录密码" id="passWord" class="layui-input">
                    ...
                    <div class="layui-form-item layui-form-text" id="hospitalNameParentContent">
                    <label class="layui-form-label">医院名</label>
                    <div class="layui-input-block">
                    <input type="text"  style="width:500px;display:inline" value="${data.hospitalName}" placeholder="请输入医院名" id="hospitalName" class="layui-input">
                        </div>
                        </div>
                        ...
                        <div class="layui-input-block">
                        <input type="text"  style="width:500px;display:inline" value="${data.address}" placeholder="请输入医院地址" id="address" class="layui-input">
                            </div>
                            </div>
                            ...
                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                                ...
                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layui/layui.js"></script>
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4871"></script>
                                        ...
                                        function submitData(){
                                            ...
                                            $.ajax({
                                                type: 'post',
                                                url: '${pageContext.request.contextPath}/admin/hospital_info/update_submit',
                                                    data:{
                                                        "id":'${data.id}',
                                                            "name":name,
                                                            "passWord":passWord,
