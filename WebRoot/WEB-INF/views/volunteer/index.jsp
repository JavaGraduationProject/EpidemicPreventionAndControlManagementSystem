...
<div class="layui-layout layui-layout-admin">
 ...
 <div class="layui-logo"><a  href="${pageContext.request.contextPath}/commonapi/index" style="color:white">返回首页</a></div>
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
     ...
     <li class="layui-nav-item layui-nav-itemed">
            ...
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="我的信息"    data-href="${pageContext.request.contextPath}/volunteer/volunteer_info/detail">我的信息  </a>  </dd>
            </dl>
 </li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">募捐管理 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="募捐管理"    data-href="${pageContext.request.contextPath}/volunteer/mj_info">募捐管理  </a>  </dd>
            </dl>
 </li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">医院需求查询 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="医院需求查询"    data-href="${pageContext.request.contextPath}/volunteer/hospital_need_info">医院需求查询  </a>  </dd>
            </dl>
 </li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">需求统计 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="需求统计"    data-href="${pageContext.request.contextPath}/commonapi/needGather/needGather">需求统计  </a>  </dd>
            </dl>
 </li>
...
addTab("我的信息", "${pageContext.request.contextPath}/volunteer/volunteer_info/detail");
function goPage(e){
