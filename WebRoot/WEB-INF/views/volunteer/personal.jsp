        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/css/global.css">
            <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/icheck/minimal/red.css">
                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                    ...
                    <tr>
                    <th width="30%">登录名</th>
                    <th width="30%">${detail.volunteerInfo.name}</th>
                        </tr>
                        <tr>
                        <th width="30%">志愿者姓名</th>
                        <th width="30%">${detail.volunteerInfo.volunteerName}</th>
                            </tr>
                            <tr>
                            <th width="30%">联系号码</th>
                            <th width="30%">${detail.volunteerInfo.volunteerCel}</th>
                                </tr>
                                <tr>
                                <th width="30%">加入时间</th>
                                <th width="30%">${detail.volunteerInfo.createTime}</th>
                                    </tr>
                                    ...
                                    <a href="${pageContext.request.contextPath}/volunteer/volunteer_info/update2?id=${detail.volunteerInfo.id}" class="layui-btn layui-btn-normal layui-btn-radius">修改</a>
                                        </div>
