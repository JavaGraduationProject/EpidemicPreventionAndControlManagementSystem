...
<c:set var="uri" value="${pageContext.request.contextPath}" />
    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/layui/css/layui.css">
            ...
            <input type="text"  style="width:500px;display:inline" value="${data.realName}" placeholder="请输入姓名" id="realName" class="layui-input">
                </div>
                </div>
                ...
                <div class="layui-input-block">
                <input type="text" class="layui-input Wdate"  readonly="readonly"  style="width:500px;display:inline" value="${data.jkTime}"  onFocus="WdatePicker({startDate: '%y-%M-%d' })"  placeholder="请输入捐款时间" id="jkTime">
                    </div>
                    </div>
                    ...
                    <div class="layui-input-block">
                    <input type="text"  style="width:500px;display:inline" value="${data.jkAmount}" placeholder="请输入捐款金额（请输入数字）" id="jkAmount" class="layui-input">
                        </div>
                        </div>
                        ...
                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                            ...
                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/My97DatePicker/4.8/WdatePicker.js"></script>
                                ...
                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layui/layui.js"></script>
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2439"></script>
                                        ...
                                        function submitData(){
                                            ...
                                            $.ajax({
                                                type: 'post',
                                                url: '${pageContext.request.contextPath}/volunteer/mj_info/update_submit',
                                                    data:{
                                                        "id":'${data.id}',
                                                            "realName":realName,
                                                            "jkTime":jkTime,
