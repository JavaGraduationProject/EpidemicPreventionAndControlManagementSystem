...
<c:set var="uri" value="${pageContext.request.contextPath}" />
    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/layui/layui/css/layui.css">
            ...
            <input type="text"  style="width:500px;display:inline" value="${data.volunteerName}" placeholder="请输入志愿者姓名" id="volunteerName" class="layui-input">
                </div>
                </div>
                ...
                <div class="layui-input-block">
                <input type="text"  style="width:500px;display:inline" value="${data.volunteerCel}" placeholder="请输入联系号码" id="volunteerCel" class="layui-input">
                    </div>
                    </div>
                    ...
                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                        ...
                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/layui/layui/layui.js"></script>
                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2621"></script>
                                ...
                                function submitData(){
                                    ...
                                    $.ajax({
                                        type: 'post',
                                        url: '${pageContext.request.contextPath}/volunteer/volunteer_info/update2_submit',
                                            data:{
                                                "id":'${data.id}',
